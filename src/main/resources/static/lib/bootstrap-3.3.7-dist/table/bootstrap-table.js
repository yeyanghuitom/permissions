    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                sprintf('<li class="page-home"><a class="page-link-home" href="javaScript:(0);">首页</a></li>',
            ...
            html.push(
                ...
                sprintf('<li class="page-trailer"><a class="page-link-trailer" href="javaScript:(0);">末页</a></li><li class="page-item page-pre"><a class="page-link" href="#">上一页</a></li><li class="page-item page-next"><a class="page-link" href="#">下一页</a></li>',
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            $home = this.$pagination.find('.page-home');
            ...
            $home.off('click').on('click', $.proxy(1, this));
