(function( $ ){
    ...
    $(function() {
        ...
        // var a = document.getElementById("juanxing").value;
        var YEARQ=sessionStorage.getItem("YEARQ");
        // var b = document.getElementById("YEARQ").value;
        var BIND_TYPE=sessionStorage.getItem("BIND_TYPE");
        // console.log(a);
        // console.log(YEARQ);
        ...
        uploader = WebUploader.create({
            ...
            server: '/permissions/questionnaire/TapeReturn',
            method:'POST',
            // runtimeOrder: 'flash',
